...
export default function GamingSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 text-center container mx-auto px-4 sm:px-6">
        <motion.div
          initial={{ scale: 0.8, opacity: 0 }}
          animate={isInView ? { scale: 1, opacity: 1 } : {}}
          transition={{ duration: 0.8, type: "spring" }}
        >
          <div className="text-cyan-400 font-mono text-xs sm:text-sm md:text-base lg:text-xl mb-3 sm:mb-4 tracking-[0.3em] sm:tracking-[0.5em] uppercase">
            Performance Mode
          </div>

          <h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-9xl font-black text-white italic tracking-tighter mb-2 cursor-default hover:scale-105 transition-transform duration-300">
            <GlitchText>120Hz</GlitchText>
          </h2>

          <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-white to-purple-500">
            UNLEASHED
          </h3>
          ...
          <motion.div
            ...
            className="mt-6 sm:mt-8 md:mt-10 flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center items-center text-gray-300"
          >
            ...
            <div className="h-px w-12 bg-gray-700 sm:hidden"></div>
            <div className="flex flex-col items-center">
              <span className="text-2xl sm:text-3xl font-bold text-white">
                HDR10+
              </span>
