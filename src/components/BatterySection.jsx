  ...
  return (
    <div ref={containerRef} className="relative h-[400vh] bg-black">
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden px-6">
        ...
        {/* BATTERY BODY */}
        <div className="w-full max-w-2xl h-32 md:h-44 border-[6px] border-gray-700 rounded-[2.5rem] p-3 relative flex items-center shadow-[0_0_50px_rgba(0,0,0,1)]">
          {/* Battery Tip */}
          <div className="absolute -right-8 top-1/2 -translate-y-1/2 w-6 h-16 bg-gray-700 rounded-r-xl" />

          {/* Inner Glow Background */}
          <div className="absolute inset-0 bg-gray-900/50 rounded-[2rem] overflow-hidden" />

          {/* FILLING BAR */}
          <motion.div
            style={{ width, backgroundColor: color }}
            className="h-full rounded-[1.5rem] relative z-10 shadow-[0_0_30px_rgba(34,197,94,0.3)] transition-colors duration-300"
          >
          ...
          <motion.div className="absolute inset-0 flex items-center justify-center z-20 mix-blend-difference">
            <span className="text-5xl md:text-6xl font-black text-white italic">
              {/* PERBAIKAN: Gunakan motion.span */}
        ...
        <div className="mt-16 h-10 overflow-hidden text-center">
          <motion.p
            style={{
